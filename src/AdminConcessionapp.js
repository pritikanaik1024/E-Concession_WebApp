  ...
  const fetchApplications = async () => {
    try {
      ...
      const applicationData = snapshot.docs.map(doc => ({
        id: doc.id,
        userId: doc.data().userId, // Include userId field
        ...doc.data()
      }));
  ...
  const fetchAddresses = async () => {
    try {
      ...
      snapshot.docs.forEach(doc => {
        ...
        userAddresses[userId] = userData.address;
      });
          ...
          {applications.map(application => (
            ...
            >
              ...
              <div>
                ...
                <div className='div-change-apply'>
                <p className="textbox-header">Address: {addresses[application.id]}</p>
                </div>
              </div>
              <br />
              <div>
